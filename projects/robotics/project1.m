...
figure(1);
subplot(121);
fplot(qFinal, [0,1], 'LineWidth', 2);
xlabel("t");
ylabel("q",'Rotation',0);

subplot(122);
fplot(dqFinal, [0,1], 'LineWidth', 2);
xlabel("t");
...
subplot(131);
hold on;
fplot(qAccelFinal, [0,0.5], 'LineWidth', 2);
fplot(qDecFinal, [0.5,1], 'LineWidth', 2);
xlabel("t");
ylabel("q",'Rotation',0);
...
subplot(132);
hold on;
fplot(dqAccelFinal, [0,0.5], 'LineWidth', 2);
fplot(dqDecFinal, [0.5,1], 'LineWidth', 2);
xlabel("t");
ylabel('$$\dot{q}$$','interpreter','latex','Rotation',0);
legend("acceleration","deceleration");
...
subplot(133);
hold on;
fplot(ddqAccelFinal, [0,0.5], 'LineWidth', 2);
fplot(ddqDecFinal, [0.5,1], 'LineWidth', 2);
xlabel("t");
...
subplot(223);
hold on;
fplot(ddqFinal, [0, 1], 'LineWidth', 2);
xlabel("t");
ylabel('$$\ddot{q}$$','interpreter','latex','Rotation',0);

subplot(224);
hold on;
fplot(dddqFinal, [0, 1], 'LineWidth', 2);
xlabel("t");
